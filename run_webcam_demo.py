...
def main():
    ...
    img_path = r"e:\Human Detection Dataset\webcam_image.jpg"
    ...
    cv2.putText(annotated, "RF-DETR TALON WEBCAM DEMO | TARGET LOCK: ACTIVE", (15, 32),
                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2, cv2.LINE_AA)
                
    output_path = r"e:\Human Detection Dataset\webcam_demo_result.jpg"
